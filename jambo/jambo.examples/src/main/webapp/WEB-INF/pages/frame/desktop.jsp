                            ...
                            <table class="table table-striped table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td class='actions_two'>
                                        <div class="btn-group">
                                            <a href="#" class="btn btn-mini tip" title="Rate"><i class="icon-star-empty icon-white"></i></a>
                                            <a href="#" class='btn btn-mini tip' title="Block"><i class="icon-ban-circle icon-white"></i></a>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
