...
<div class="content">
    <div class="box">
        <div class="box-head">
            <h3><fmt:message key="content"  bundle="${example1}"/> SpringAction</h3>
        </div>
        <div class="box-content">
            ...
            <form id="formItem" name="formItem" action="<%=contextPath %>/example/example2/example2Action/save.do" class="form-horizontal validate"  method="post" >
                ...
                <div class="form-actions">
                    <button class="btn btn-primary" type="submit" onclick="doSave('/example/example2/example2Action/save.do')">
                        <fmt:message key='button_save'/></button>
                    <input type="reset" class='btn btn-danger' value="<fmt:message key='button_reset'/>">
                    <a href="javascript:void(0);" onclick="doReturn('/example/example2/example2Action/list.do')" class="btn btn-info">
