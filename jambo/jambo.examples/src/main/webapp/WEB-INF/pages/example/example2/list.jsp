...
<div class="content">
    <div class="row-fluid">
        <form id="formList" name="formList" action="<%=contextPath %>/example/example2/example2Action/list.do" class="form-search">
            <div class="row-fluid force-margin">
                ...
                <div class="box">
                    <div class="box-head">
                        <h3><fmt:message key="list"  bundle="${example1}"/> SpringAction</h3>
                        <div class="actions">
                            <ul>
                                <li>
                                    <a href="javascript:void(0);" onclick="doNew('/example/example2/example2Action/add.do')" class="btn btn-square">
                                        <fmt:message key='button_new'/></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0);" onclick="doDelete('/example/example2/example2Action/delete.do')" class="btn btn-square">
                            ...
                            <tbody>
                                <c:forEach items="${dp.datas}" var="data">
                                    <tr>
                                        ...
                                        <td>${data.id}</td>
                                        <td><a href="<%=contextPath %>/example/example2/example2Action/edit.do?_pk=${data.id}">${data.companyname}</a></td>
