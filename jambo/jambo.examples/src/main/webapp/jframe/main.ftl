...
<div id="title">
    <div class="container">
        ...
        <div id="top-nav">
            ...
            <ul class="pull-right">
                <li><a href="javascript:;">新消息<span class="label label-danger">1024</span></a></li>
            ...
            <li class='dropdown dropdown-noclose supportContainer'>
                ...
                <ul class="dropdown-menu pull-right custom custom-dark">
                    <li class='custom'>
                        ...
                        <div class="action">
                            <div class="btn-group">
                                <a href="#" class='tip btn btn-mini' title="Show ticket"><i class="glyphicon glyphicon-search glyphicon glyphicon-white"></i></a>
                                <a href="#" class='tip btn btn-mini' title="Delete ticket"><i class="glyphicon glyphicon-remove glyphicon glyphicon-white"></i></a>
                            </div>
                        </div>
                    </li>
                    <li class='custom'>
                    ...
                    <li class='custom custom-hidden'>
                        ...
                        <div class="action">
                            <div class="btn-group">
                                <a href="#" class='tip btn btn-mini' title="Show ticket"><i class="glyphicon glyphicon-search glyphicon-white"></i></a>
                                <a href="#" class='tip btn btn-mini' title="Delete ticket"><i class="glyphicon glyphicon-remove glyphicon-white"></i></a>
                            </div>
                        </div>
                    </li>
                    <li class='custom custom-hidden'>
            ...
            <li class='dropdown pendingContainer'>
                ...
                <ul class="dropdown-menu pull-right custom custom-dark">
                    <li class='custom'>
                        ...
                        <div class="action">
                            <div class="btn-group">
                                <a href="#" class='tip btn btn-mini' title="Show order"><i class="glyphicon glyphicon-search glyphicon-white"></i></a>
                                <a href="#" class='tip btn btn-mini' title="Delete order"><i class="glyphicon glyphicon-remove glyphicon-white"></i></a>
                            </div>
                        </div>
                    </li>
                </ul>
            ...
            <li class='dropdown messageContainer'>
                ...
                <ul class="dropdown-menu pull-right custom custom-dark">
                    <li class='custom'>
                        ...
                        <div class="action">
                            <div class="btn-group">
                                <a href="#" class='tip btn btn-mini' title="Show message"><i class="glyphicon glyphicon-search glyphicon-white"></i></a>
                                <a href="#" class='tip btn btn-mini' title="Reply message"><i class="glyphicon glyphicon-comment glyphicon-white"></i></a>
                            </div>
                        </div>
                    </li>
                </ul>
        ...
        <div class="container-fluid">
            <div class="box-head tabs-main tabs">
                <ul id="tabs" class="nav nav-tabs nav-tabs-main" style="border-bottom-width:0px">
                    ...
                    <li class='active'>
                        <a href="#0" data-toggle="tab"><i class="glyphicon glyphicon-home glyphicon-white"></i>工作台</a>
                    </li>
                    <li class="dropdown">
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <i class="glyphicon glyphicon-caret-down bigger-110 width-auto"></i>
                        </a>
    ...
    <div class="container-fluid">
        <div  id="tabWin" class="tab-content">
            <div class="tab-pane active" id="0">
                <iframe src="${contextPath}/redirect.do?url=jframe/desktop" width="100%" frameborder="0" onload="Javascript:setWinHeight(this)"></iframe>
            </div>
        </div>
    </div>
</div>
