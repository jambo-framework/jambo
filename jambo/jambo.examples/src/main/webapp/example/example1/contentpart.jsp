...
<div class="content">
    <div class="box">
        <div class="box-head">
            <h3><fmt:message key="content"  bundle="${example1}"/>part</h3>
        </div>
        <div class="box-content">
            ...
            <form id="formItem" name="formItem" action="<%=contextPath %>/example/example1/example1PartAction/save.do" class="form-horizontal validate"  method="post" >
                ...
                <div class="form-actions">
                    <button class="btn btn-primary" type="submit" onclick="doSave('/example/example1/example1PartAction/save.do')">
                        <fmt:message key='button_save'/></button>
                    <input type="reset" class='btn btn-danger' value="<fmt:message key='button_reset'/>">
                    <a href="javascript:void(0);" onclick="doReturn('/example/example1/example1PartAction/list.do')" class="btn btn-info">
