...
<div class="content">
    <div class="row-fluid">
        <form id="formList" name="formList" action="<%=contextPath %>/example/dubbo1/dubbo1Action/list.do" class="form-search">
            <div class="row-fluid force-margin">
                ...
                <div class="box">
                    <div class="box-head">
                        <h3><fmt:message key="list"  bundle="${example1}"/> Dubbo</h3>
                        <div class="actions">
                            <ul>
                                <li>
                                    <a href="javascript:void(0);" onclick="doNew('/example/dubbo1/dubbo1Action/add.do')" class="btn btn-square">
                                        <fmt:message key='button_new'/></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0);" onclick="doDelete('/example/dubbo1/dubbo1Action/delete.do')" class="btn btn-square">
                            ...
                            <tbody>
                                <c:forEach items="${dp.datas}" var="data">
                                    <tr>
                                        ...
                                        <td>${data.id}</td>
                                        <td><a href="<%=contextPath %>/example/dubbo1/dubbo1Action/edit.do?_pk=${data.id}">${data.companyname}</a></td>
