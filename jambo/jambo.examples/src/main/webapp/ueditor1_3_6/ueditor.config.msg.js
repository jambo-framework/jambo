...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        ,maxImageSideLength:90000                   //上传图片最大允许的边长，超过会自动等比缩放,不缩放就设置一个比较大的值，更多设置在image.html中
        ,savePath: [ '../../upload/editor/'+websiteId+"/"]    //图片保存在服务器端的目录， 默认为空， 此时在上传图片时会向服务器请求保存图片的目录列表，
        ...
        //附件上传配置区
        ,fileUrl:URL+"jsp/fileUp.jsp?appId="+websiteId          //附件上传提交地址
        ...
        ,catcherUrl:URL +"jsp/getRemoteImage.jsp?appId="+websiteId    //处理远程图片抓取的地址
        ...
        ,videoUrl:URL+"jsp/fileUp.jsp?appId="+websiteId               //附件上传提交地址
        ,videoPath:"/"                   //附件修正地址，同imagePath
        //,videoFieldName:"upfile"                    //附件提交的表单名，若此处修改，需要在后台对应文件修改对应参数
 
        //工具栏上的所有的功能按钮和下拉框，可以在new编辑器的实例时选择自己需要的从新定义
        , toolbars:[["Source","Bold","Italic","Underline","InsertUnorderedList","InsertOrderedList","InsertImage","Link","insertvideo","attachment","inserttable","Link","RemoveFormat","FontSize","ForeColor","BackColor",'justifyleft', 'justifycenter', 'justifyright', 'justifyjustify','map']]
